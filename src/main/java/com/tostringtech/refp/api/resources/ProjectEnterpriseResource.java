...
public class ProjectEnterpriseResource {
    ...
    public ProjectEnterpriseResource(Empresa enterprise, Boolean active, String type) {
        this.setId(enterprise.getCodEmpresa());
        this.setCnpj(enterprise.getNrCnpj());
        this.setCompany(enterprise.getDescRazaoSocial());
        this.setTrade(enterprise.getDescNomeFantasia());
        this.setInitials(enterprise.getDescSigla());
        this.setActive(active);
        this.setType(type);
    }

    public ProjectEnterpriseResource(Empresa enterprise, String active, String type) {
        this.setId(enterprise.getCodEmpresa());
        this.setCnpj(enterprise.getNrCnpj());
        this.setCompany(enterprise.getDescRazaoSocial());
        this.setTrade(enterprise.getDescNomeFantasia());
